...
var _lottery = __webpack_require__(128);

var _lottery2 = _interopRequireDefault(_lottery);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var syy = new _lottery2.default(); //import 'babel-polifill';
...
var _inerface = __webpack_require__(336);

var _inerface2 = _interopRequireDefault(_inerface);
...
//深度拷贝
var copyProprties = function copyProprties(target, source) {
...
var Lottery = function (_mix) {
    ...
    return Lottery;
}(mix(_base2.default, _calculate2.default, _inerface2.default, _timer2.default));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(91), __webpack_require__(125)(module)))
    ...
    _createClass(Base, [{
        ...
        value: function initPlayList() {
            this.play_list.set('r2', {
                Bonus: 6,
                tip: '从01～11中任选2个或多个号码，所选号码与开奖号码任意两个号码相同，即中奖<em class="res">6</em>元',
                name: '任二'
            }).set('r3', {
                bonus: 19,
                tip: '从01～11中任选3个或多个号码，所选号码与开奖号码任意三个号码相同，即中奖<em class="res">19</em>元',
                name: '任三'
            }).set('r4', {
                bonus: 78,
                tip: '从01～11中任选4个或多个号码，所选号码与开奖号码任意四个号码相同，即中奖<em class="res">78</em>元',
                name: '任四'
            }).set('r5', {
                bonus: 540,
                tip: '从01～11中任选5个或多个号码，所选号码与开奖号码任意五个号码相同，即中奖<em class="res">540</em>元',
                name: '任五'
            }).set('r6', {
                bonus: 90,
                tip: '从01～11中任选6个或多个号码，所选号码与开奖号码任意六个号码相同，即中奖<em class="res">90</em>元',
                name: '任六'
            }).set('r7', {
                bonus: 26,
                tip: '从01～11中任选7个或多个号码，所选号码与开奖号码任意七个号码相同，即中奖<em class="res">26</em>元',
                name: '任七'
            }).set('r8', {
                bonus: 9,
                tip: '从01～11中任选8个或多个号码，所选号码与开奖号码任意八个号码相同，即中奖<em class="res">9</em>元',
                name: '任八'
            });
        }
        ...
        value: function initNumber() {
            for (var i = 1; i < 12; i++) {
                this.number.add(('' + i).padStart(2, '0')); //字符串保持两位长度，如果不够，用0填充
            }
        }
        ...
        value: function setOmit() {
            ...
            try {
                for (var _iterator = omit.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    self.omit.set(_index, _item); //map对象是可重复的
                }
                //利用jquery完成dom操作
            } catch (err) {
                _didIteratorError = true;
            ...
            (0, _jquery2.default)(self.omit_el).each(function () {
        ...
        value: function setOpenCode(code) {
            ...
            try {
                for (var _iterator2 = code.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    self.open_code.add(_item2); //set对象是不可重复的
                }
            } catch (err) {
                _didIteratorError2 = true;
                _iteratorError2 = err;
            ...
            self.updateOpenCode && slef.updateOpenCode.call(self, code);
        }
        ...
        value: function addCodeItem(code, type, typeName, count) {
            ...
            (0, _jquery2.default)(self.art_el).append(tpl);
            self.getTotal();
        }
    }, {
        key: 'getCount',
        value: function getCount() {
            ...
            if (count === 0) {
                tpl = '\u60A8\u9009\u4E86<b class="red">' + count + '</b>\u6CE8\uFF0C\u5171<b class="red">0</b>\u5143';
            } else if (range[0] === range[1]) {
                tpl = '\u60A8\u9009\u4E86<b class="red">' + count + '</b>\u6CE8\uFF0C\u5171<b class="red">' + count * 2 + '</b>\u5143  <em>\u82E5\u4E2D\u5956\uFF0C\n            \u5956\u91D1\uFF1A<strong class="red">' + range[0] + '</strong>\u5143,\u60A8\u5C06' + (win1 >= 0 ? '盈利' : '亏损') + '\n            <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + Math.abs(win1) + '</strong>\u5143</em>';
            } else {
                tpl = '\u60A8\u9009\u4E86<b class="red">' + count + '</b>\u6CE8\uFF0C\u5171<b class="red">' + count * 2 + '</b>\u5143  <em>\u82E5\u4E2D\u5956\uFF0C\n            \u5956\u91D1\uFF1A<strong class="red">' + range[0] + '</strong>\u81F3<strong class="red">' + range[1] + '</strong>,\n            \u60A8\u5C06' + (win1 < 0 && win2 < 0 ? '亏损' : '盈利') + '<strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c1 + '</strong>\n            \u81F3<strong class="' + (win2 >= 0 ? 'red' : 'green') + '">' + c2 + '</strong>\u5143</em>';
            }
...
var Calculate = function () {
    ...
    _createClass(Calculate, [{
         ...
         * @param {play_name}   [当前玩法 R2 R3 R4 R5...R8]
         * @return {number}  [注数]
         */
